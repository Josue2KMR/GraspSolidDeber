...
namespace Full_GRASP_And_SOLID
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            textPrint.FinalProduct = GetProduct("Café con leche");
            textPrint.AddStep(GetProduct("Café"), 100, GetEquipment("Cafetera"), 120);
            textPrint.AddStep(GetProduct("Leche"), 200, GetEquipment("Hervidor"), 60);
            textPrint.AddStep("Dejar enfriar", 60);

            IPrinter printer;
            printer = new ConsolePrinter();
            printer.PrintRecipe(textPrint);
